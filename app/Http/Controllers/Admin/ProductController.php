...
//		return redirect()->route('product');
	...
	public function fusion(){
		...
		$ProductAttivuteValues = ProductAttributeValue::where('attribute_id','=','10')->orwhere('attribute_id','=','57')->get();
		//$ProductAttivuteValues = ProductAttributeValue::where('attribute_id','=','72')->get();
