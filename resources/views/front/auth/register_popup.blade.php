    ...
    <div class="account-area">
            <div class="row">
                ...
                <div class="register-area">
                    ...
                    <div class="col-md-12 register-area {!! ($role_id==2) ? "hidden": "" !!}" style="text-align: center">
                        ...
                        <div class="social-left">
                            ...
                            <span class="mr-lft-5px">
                                <input value="{!! Cookie::has('zip_code') ? Cookie::get('zip_code') : '' !!}" type="text" name="zip_code" class="radius-input required" placeholder="{!! trans("common/label.postal_code")!!}">
                            </span>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mg-18">
                            ...
                            <div class="register-area">
                                <div class="">
                                    ...
                                    {{Form::text('first_name', '',['class'=>'required' , 'placeholder' => trans("form.first_name")])}}
                                </div>
                                <div class="">
                                    {{-- <label for="username">{!! trans("form.last_name")!!} <span>*</span></label> --}}
                                    {{Form::text('last_name', '',['class'=>'required', 'placeholder' => trans("form.last_name")])}}
                                </div>
                                ...
                                <div class="">
                                   {{--  <label for="phone_number">{!! trans("form.phone_number")." ".trans('form.for_phone')!!} </label> --}}
                                    {{Form::text('phone_number', '',['class'=>'' , 'placeholder' => trans("form.phone_number")." ".trans('form.for_phone')])}}
                                </div>

                                <div class="">
                                    {{-- <label for="password">{!! trans("form.password")!!}<span>*</span></label> --}}
                                    {{Form::password('password',['class'=>'required', 'id'=>"password", 'placeholder' => trans("form.password")])}}
                                </div>
                                <div class="">
                                   {{--  <label for="password">{!! trans("form.confirm_password")!!}<span>*</span></label> --}}
                                    {{Form::password('confirm_password', ['class'=>'required', 'id'=>"password", 'placeholder' => trans("form.confirm_password") ])}}
                                </div>
                            ...
                            <div class="register-footer-area text-center">
                                <button type="submit" id="register-btn">{!! trans("form.submit_button")!!}</button>
                            </div>
                        {!! Form::close() !!}
                        ...
                        {{-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 social-media">
                            <register-area-start>
